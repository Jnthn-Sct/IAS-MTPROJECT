...
<body>
    <div class="sidebar">
        ...
        <nav class="nav">
            ...
            <a href="#" class="nav-link"><i class="fa fa-user"></i><span>My Profile</span></a>
        </nav>
    ...
    <div class="main-content">
        <div class="dashboard-header">
            ...
            <div class="greeting">Welcome, <?php echo htmlspecialchars($_SESSION['user_name']); ?>!</div>
        </div>
        <div class="features-section content-section active" id="dashboardSection">
            ...
            <div class="features-grid">
                <div class="feature-card" data-feature="Emergency Contacts">
                    ...
                    <div class="feature-desc">Quick access to emergency numbers and contacts.</div>
                </div>
                ...
                <div class="feature-card" data-feature="Incident Reporting">
                    <div class="feature-icon">📝</div>
                    <div class="feature-title">Incident Reporting</div>
                    <div class="feature-desc">Report incidents quickly and easily.</div>
                </div>
                <div class="feature-card" data-feature="Public Safety Agencies">
                    <div class="feature-icon">🏢</div>
                    <div class="feature-title">Public Safety Agencies</div>
                    <div class="feature-desc">Integrated with local safety agencies.</div>
                </div>
                <div class="feature-card" data-feature="Wearable Devices">
                    <div class="feature-icon">⌚</div>
                    <div class="feature-title">Wearable Devices</div>
                    <div class="feature-desc">Connect your safety wearables.</div>
                </div>
                <div class="feature-card" data-feature="Geofencing Alerts">
                    <div class="feature-icon">📍</div>
                    <div class="feature-title">Geofencing Alerts</div>
                    <div class="feature-desc">Get alerts based on your location.</div>
                </div>
                <div class="feature-card" data-feature="Multi-language Support">
                    <div class="feature-icon">🌐</div>
                    <div class="feature-title">Multi-language Support</div>
                    <div class="feature-desc">Use the dashboard in your language.</div>
                </div>
                <div class="feature-card" data-feature="Customizable Alerts">
                    <div class="feature-icon">⚙️</div>
                    <div class="feature-title">Customizable Alerts</div>
                    <div class="feature-desc">Set your own alert preferences.</div>
                </div>
                <div class="feature-card" data-feature="Safety Map">
                    <div class="feature-icon">🗺️</div>
                    <div class="feature-title">Safety Map</div>
                    <div class="feature-desc">View safe and unsafe zones on the map.</div>
                </div>
            </div>
        </div>
